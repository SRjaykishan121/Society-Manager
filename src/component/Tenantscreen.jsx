        ...
        <div className="container-fluid form-container" style={{ backgroundColor: "#eff4f9" }}>
            <div className="row justify-content-center ">
                <div className="col-lg-10">
                    <Link to="/owner" className="rounded-top border-top-only btn btn-primary text-white">Owner</Link>
                    <button className="rounded-top border-top-only btn btn-light">Tenant</button>
                    <form  className='border p-4 rounded shadow bg-white mb-3'>
                        <div className="row">
                        <div className="col-md-4">
                                ...
                                <div className="col-md-4">
                                    <label>Owner Phone<span className='text-danger'>*</span></label>
                                    <input type="tel" className="form-control" name="" placeholder="+91" />
                                </div>
                                <div className="col-md-4">
                                    <label>Owner Address<span className='text-danger'>*</span></label>
                                    <input type="email" className="form-control" name="" placeholder="Enter Address" />
                                </div>
                        </div>
                    </form>
